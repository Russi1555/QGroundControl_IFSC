...
MacBuild {
    ...
    ICON                = $${SOURCE_DIR}/resources/icons/qgroundcontrol.png
...
WindowsBuild {
    ...
    QGC_INSTALLER_ICON          = "$$SOURCE_DIR\\deploy\\windows\\qgroundcontrol_teste.ico" #mudança do icone
...
CustomBuild {
    ...
    DEFINES += QGC_APPLICATION_NAME=\"\\\"QGroundControl\\\"\" #Não entendi o que faz. alterar não muda nada
